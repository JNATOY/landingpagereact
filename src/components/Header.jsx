        ...
        <div className='shadow-md w-full fixed top-0 left-0'>
            <div className='md:px-10 py-4 px-7 md:flex justify-between items-center bg-white'>
                ...
                `}>
                    {
                        Links.map(link => (
                            <li className='font font-semibold my-7 md:my-0 md:ml-8'>
                                <a href="/">{link.name}</a>
                            </li>))
                    }
                    <button className='btn bg-blue-600 text-white py-1 px-3 md:ml-8 rounded md:static'>Quiero Comprar</button>
                </ul>
            </div>
        </div>
    );
